...
<CardGroup cols={2}>
  ...
  <Card title="Simulation" icon="flask">
    Test workflows interactively before publishing. Run two workflows side-by-side in a sandboxed simulation environment to validate logic and outputs.
  </Card>
...
<Steps>
  ...
  <Step title="Simulate Before Publishing">
    Use the Simulation feature to run your workflow interactively. Validate branching logic, tool responses, and conversation flow in a safe sandbox.
  </Step>
