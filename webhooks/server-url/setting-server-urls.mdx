...
### In the Dashboard
If you go to the [assistant section](https://dashboard-qa.interactly.ai/assistants) of your dashboard, in the **"Advanced"** tab you will see a setting to set the assistant's server URL:
...
### In the Dashboard
In the [tools section](https://dashboard-qa.interactly.ai/tools) of your dashboard, You can define multiple tools and give Server URLs to each of them.
...
If you go to the [assistant section](https://dashboard-qa.interactly.ai/assistants) of your dashboard, in the **"Functions"** tab you will see a setting to select Assistant Tools:
